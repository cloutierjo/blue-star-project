...
class Onglets(object):
    def __init__(self,vueParent):
        ...
        self.v = IntVar()
        r=Radiobutton(self.frame, text=u"Mandat/Analyse Explicite",variable=self.v, value=1,indicatoron=False,command=self.vueParent.afficherFenMandat)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
        r=Radiobutton(self.frame, text=u"Analyse Explicite/Implicite", variable=self.v, value=2,indicatoron=False,command=self.vueParent.afficherLesAnalyses)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
        r=Radiobutton(self.frame, text=u"Analyse Explicite/Cas d'usage", variable=self.v, value=3,indicatoron=False,command=self.vueParent.afficherCasUsage)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
        r=Radiobutton(self.frame, text=u"Cas d'usage/Scenario d'utilisation", variable=self.v, value=4,indicatoron=False,command=self.vueParent.afficherScenario)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
        
        r=Radiobutton(self.frame, text=u"CRC", variable=self.v, value=6,indicatoron=False,command=self.vueParent.afficherCRC)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
        
        r=Radiobutton(self.frame, text=u"Planning", variable=self.v, value=7,indicatoron=False,command=self.vueParent.afficherPlanning)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
        
        r=Radiobutton(self.frame, text=u"Scrum", variable=self.v, value=8,indicatoron=False,command=self.vueParent.afficherScrum)
        r.config(activeforeground="blue",relief=RIDGE)
        r.pack(side=LEFT)
